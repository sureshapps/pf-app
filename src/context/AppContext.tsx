...
const defaultData: AppData = {
  ...
  social: [
    { platform: 'Behance', url: 'https://behance.com/mesureshks', color: '#0077B5' },
    { platform: 'Facebook', url: 'https://facebook.com/mesureshks', color: '#3b5998' },
    { platform: 'Twitter', url: 'https://x.com/sureshksmy', color: '#1DA1F2' },
    { platform: 'Instagram', url: 'https://instagram.com/sureshksmy', color: '#E4405F' },
  ],
  stats: {
    projects: '500+',
    clients: '200+',
  ...
  appSettings: {
    appName: 'SURESH.app',
    appDescription: 'Creative Developer Portfolio - Showcasing creative digital experiences',
    appIcon: '/profile.jpg',
    tags: ['portfolio', 'design', 'ui/ux', 'development', 'mobile', 'app'],
    themeColor: '#FF6B6B',
